...
GitHub release: PASS - v0.1.9 portable ZIP published
```
...
- Code signing, multi-version Windows E2E and installer verification remain follow-up work; the published ZIP is unsigned.
...
- Decide on a code-signing certificate for a future signed installer.
