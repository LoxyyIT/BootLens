...
The publish script creates artifacts/BootLens-0.1.9-win-x64.zip. An installer is created only when Inno Setup 6 is installed on the build machine. The app targets net10.0-windows and the portable publish is self-contained for win-x64.
