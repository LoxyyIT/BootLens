...
The publish script creates artifacts/BootLens-0.2.6-win-x64.zip, artifacts/BootLens.exe and a SHA-256 checksum file. An installer is created when Inno Setup 6 is installed on the build machine. The app targets net10.0-windows, requests administrator rights at launch and the portable publish is self-contained for win-x64.
